...
def encry(encrypath, x1, x2, x3, x4):
    file_path = get_original_img_path()
...
def test2(x1, x2, x3, x4, x5, x6, x7, x8):
    """
    TODO: 追踪替换 encrypath。
    """
    print(x1.flat[:20])
    ...
    recover_image(I1_prime, I2_prime, I3_prime, file_path, get_encrypted_img_path())
    ...
    recover_image(I1_prime, I2_prime, I3_prime, get_original_img_path(), get_decrypted_img_path())
...
def test(encrypath, x1, x2, x3, x4, x5, x6, x7, x8):
    ...
    img = recover_image(I1_prime, I2_prime, I3_prime, file_path, get_encrypted_img_path())
    ...
    I3_prime = reshape_blocks(dncrypted_blocks_I3, p)
    #
    img = recover_image(I1_prime, I2_prime, I3_prime, encrypath, get_decrypted_img_path())
